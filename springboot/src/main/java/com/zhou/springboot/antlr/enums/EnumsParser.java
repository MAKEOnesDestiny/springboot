...
public class EnumsParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "Enums.g4"; }
	...
	public EnumsParser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).exitProg(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EnumsVisitor ) return ((EnumsVisitor<? extends T>)visitor).visitProg(this);
	...
	public static class StatContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).enterStat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).exitStat(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EnumsVisitor ) return ((EnumsVisitor<? extends T>)visitor).visitStat(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public TerminalNode INT() { return getToken(EnumsParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EnumsVisitor ) return ((EnumsVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EnumDeclContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).enterEnumDecl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).exitEnumDecl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EnumsVisitor ) return ((EnumsVisitor<? extends T>)visitor).visitEnumDecl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IdContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(EnumsParser.ID, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).enterId(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EnumsListener ) ((EnumsListener)listener).exitId(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EnumsVisitor ) return ((EnumsVisitor<? extends T>)visitor).visitId(this);
			else return visitor.visitChildren(this);
		}
	}
